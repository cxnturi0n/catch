...
export interface WorkspaceReport {
  ...
  /** Deterministic intelligence report narrative (modules/ai/report), when available. */
  narrative?: { summary: string[]; recommendations: { title: string; priority: string }[]; source: 'rules' | 'llm' }
}
