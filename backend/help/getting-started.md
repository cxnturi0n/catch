...
How to set up Catch and onboard your first client
...
3. Add your first workspace/client
4. Connect your platforms via Integrations
5. Build your team in Team → Moderators
